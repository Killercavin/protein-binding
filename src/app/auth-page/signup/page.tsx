          ...
          >
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <div>
                ...
                <div className="mb-4">
                  <label htmlFor="bio" className="mb-2.5 block font-medium text-black dark:text-white">
                    Bio
                  </label>
                  <div className="relative">
                    <textarea
                      id="bio"
                      name="userBio"  // Ensure the name matches the user state key
                      value={user.userBio || ""}  // Fallback to empty string if userBio is undefined
                      onChange={handleInputChange}
                      placeholder="Enter your bio"
                      aria-label="User Bio"  // Accessibility improvement
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
                  </div>
                </div>
