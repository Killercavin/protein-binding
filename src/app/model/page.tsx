        ...
        <div className="flex flex-col gap-9">
          <div className="rounded-lg border border-stroke bg-white p-3 shadow-default dark:border-[#121212] dark:bg-[#181818]">
            ...
            <div className="mt-4 max-h-96 overflow-y-auto">
              {history.map((entry: { smiles: string; numMolecules: number; createdAt: string; generatedMolecules: { structure: string; score: number }[] }, index) => (
        ...
        <div className="mt-8 rounded-lg bg-white p-2">
          <div className="mt-8 flex flex-col  gap-2">
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
              {molecules.map((mol: { structure: string; score: number }, index) => (
                <MoleculeStructure
                  key={index}
                  id={`mol-${index + 1}`}
